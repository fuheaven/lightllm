...
def main():
    ...
    parser.add_argument("--mode", type=str, default=[], nargs='+',
                        ...
                        [triton_int8weight | triton_int4weight | lmdeploy_int4weight | ppl_int4weight | ppl_int8_activation_weight], 
                        ...
                        triton_int8weight and triton_int4weight and lmdeploy_int4weight and ppl_int4weight or ppl_int8_activation_weight mode use int8 and int4 to store weights;
