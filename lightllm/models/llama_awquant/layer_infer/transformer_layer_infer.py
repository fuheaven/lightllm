...
class LlamaTransformerLayerInferAWquant(TransformerLayerInferActivationWeightQuantTpl):
    ...
    def _get_qkv(self, input, cache_k, cache_v, infer_state:LlamaInferStateInfo, layer_weight:LlamaTransformerLayerActivationWeightQuantized)->torch.Tensor:
    ...
    def _ffn(self, input, infer_state: LlamaInferStateInfo, layer_weight: LlamaTransformerLayerActivationWeightQuantized, token_scale) -> torch.Tensor:
    ...
    def _context_ffn(self, input_embdings, infer_state: LlamaInferStateInfo, layer_weight):
        ...
        ffn_out = self._ffn(input1, infer_state, layer_weight, token_scale)
